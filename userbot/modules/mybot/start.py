...
import re
from userbot.modules.mybot import *
from telethon import events, Button
import heroku3
import asyncio
import os
import requests
from userbot.modules.mybot.sql.blacklist_sql import all_bl_users
from userbot.modules import TELE_NAME
from userbot.modules.mybot.sql.userbase_sql import add_to_userbase, present_in_userbase, full_userbase
    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      [Button.url(
                                          "AkenoXNew", url="https://github.com/rizgustiadi/AkenoXNew")],
                                      [Button.inline(
...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        buttons=[
            ...
            [Button.url("Crashed?", "t.me/AkenoXNew")]
        ])
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com/rizgustiadi/AkenoXNew")),
                          (Button.url("Deploy", url="https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Frizgustiadi%2FAkenoXNew%2F&template=https%3A%2F%2Fgithub.com%2Frizgustiadi%2FAkenoXNew"))],
                         [Button.url("Support",
                                     url="https://t.me/OreBaka")]
                     ])
